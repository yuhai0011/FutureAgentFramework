...
public class StorageUtils {
    ...
    /**
     * Get the absolute path of a relative path on the external storage (SD
     * card)
     */
     ...
     * 
     * @return Return the available external storage size in bytes if possible,
     *         otherwise -1
     */
    @SuppressWarnings("deprecation")
     ...
     * 
     * @return Return the total external storage size in bytes if possible,
     *         otherwise -1
     */
    @SuppressWarnings("deprecation")
     ...
     * 
     * @return Return the available extra SD card in bytes if possible,
     *         otherwise -1
     */
    @SuppressWarnings("deprecation")
     ...
     * 
     * @return Return the total extra SD card size in bytes if possible,
     *         otherwise -1
     */
    @SuppressWarnings("deprecation")

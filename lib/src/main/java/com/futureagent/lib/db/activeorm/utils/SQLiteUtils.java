package com.futureagent.lib.db.activeorm.utils;
...
public final class SQLiteUtils {
    ...
    public static String createColumnDefinition(TableInfo tableInfo, Field field) {
        ...
        } else if (ReflectUtil.isModel(type)) {
            definition.append(name);
            definition.append(" ");
            definition.append(SQLiteType.INTEGER.toString());
        } else if (ReflectUtil.isSubclassOf(type, Enum.class)) {
            definition.append(name);
            definition.append(" ");
        ...
        if (!TextUtils.isEmpty(definition)) {
            ...
            if (FOREIGN_KEYS_SUPPORTED && ReflectUtil.isModel(type)) {

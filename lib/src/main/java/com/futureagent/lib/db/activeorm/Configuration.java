    ...
    public static class Builder {
        ...
        public Configuration create() {
            ...
            if (mModelClasses != null) {
                ...
                final String modelList = ReflectUtil.getMetaData(mContext, AA_MODELS);
                if (modelList != null) {
            ...
            if (mTypeSerializers != null) {
                ...
                final String serializerList = ReflectUtil.getMetaData(mContext, AA_SERIALIZERS);
        ...
        private String getMetaDataDatabaseNameOrDefault() {
            String aaName = ReflectUtil.getMetaData(mContext, AA_DB_NAME);
            if (aaName == null) {
        ...
        private int getMetaDataDatabaseVersionOrDefault() {
            Integer aaVersion = ReflectUtil.getMetaData(mContext, AA_DB_VERSION);
        ...
        private String getMetaDataSqlParserOrDefault() {
            final String mode = ReflectUtil.getMetaData(mContext, AA_SQL_PARSER);
            if (mode == null) {
        ...
        private List<Class<? extends Model>> loadModelList(String[] models) {
            ...
            for (String model : models) {
                try {
                    ...
                    if (ReflectUtil.isModel(modelClass)) {
        ...
        private List<Class<? extends TypeSerializer>> loadSerializerList(String[] serializers) {
            ...
            for (String serializer : serializers) {
                try {
                    ...
                    if (ReflectUtil.isTypeSerializer(serializerClass)) {
